...
CycleTerminator<Edge, Graph>::CycleTerminator(std::vector<Edge> & _removal_list) : removal_list(_removal_list)
{
    
}

template <class Edge, class Graph> void
CycleTerminator<Edge, Graph>::back_edge(Edge e, const Graph& g)
{
